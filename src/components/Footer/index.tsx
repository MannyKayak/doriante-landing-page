      ...
      <div className="mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="grid gap-16 md:grid-cols-3">
          ...
          <div className="max-w-sm">
            <h3 className="mb-6 font-serif text-4xl tracking-wide text-black">
              DORIANTE
            </h3>

            <p className="mb-10 text-base leading-7 text-black/80">
              An art hotel experience on the shores of Lago d&apos;Orta, where
              elegance and creativity inspire slow living.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-base text-black/80">
              ...
              <li>
                <a
                  href="mailto:welcome@doriante.it"
                  className="hover:text-black transition"
                >
                  welcome@doriante.it
                </a>
